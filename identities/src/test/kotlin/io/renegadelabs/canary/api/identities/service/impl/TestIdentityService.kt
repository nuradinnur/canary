            ...
            then("it should return empty") {
                ...
                StepVerifier.create(verification)
                    .consumeNextWith { identity ->
                        ...
                        identity.isAccountExpired().shouldNotBeNull().shouldBe(false)
                        identity.isAccountLocked().shouldNotBeNull().shouldBe(false)
                        identity.hasExpiredCredentials().shouldNotBeNull().shouldBe(false)
